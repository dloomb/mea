...
//    private static void associate(Map<String, Map> objects)
//    {
//        for (String groupType : objects.keySet())
//        {
//            Map<String, Model> group = (Map) objects.get(groupType);
...
//            for (Model model : models)
//            {
//                for (String relationType : model.mRelationshipMap.keySet())
//                {
//
//                }
//            }
...
//    }
    ...
    private static String classNameFromType(String type)
    {
        ...
        return "com.meamobile.printicular_sdk.models." + out;
    }
}
